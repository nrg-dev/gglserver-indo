...
@FunctionalInterface
public interface EmployerEmailService {
	public static final Logger logger = LoggerFactory.getLogger(EmployerEmailService.class);

	public void test();
	
	public default boolean employerRegistration(EmployerDto employerdto){
		...
		String email1 ="<html> <head> <style> div {  background-color: white; }</style> </head>\r\n" + 
			...
			"<p> Dear Job Seeker,</p> \r\n" + 
			"\r\n" + 
			"<p> Here are the login details for your GGL Employer Account.\r\n" + 
			"</p>	\r\n" + 
			"\r\n" + 
			"<p> \r\n" + 
			"User ID: "+employerdto.getEmailID()+"\r\n" + 
			"</p>	\r\n" + 
			"\r\n" + 
			"<p> \r\n" + 
			"To change your password: <a href=\"http://ggl.neotural.com/employerlogin\"> Click Here</a> \r\n" + 
			"</p>	\r\n" + 
			"\r\n" + 
			"\r\n" + 
			...
			PushEmail.sendMail(employerdto.getEmailID(),"your account information from www.gglway.com ",email1);
